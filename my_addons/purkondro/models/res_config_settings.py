...
class ResConfigSettings(models.TransientModel):
    ...
    group_warning_purchase = fields.Boolean("Purchase Warnings", implied_group='purkondro.group_warning_purchase')
    ...
    use_po_lead = fields.Boolean(
        ...
        config_parameter='purkondro.use_po_lead',
    ...
    group_send_reminder = fields.Boolean("Receipt Reminder", implied_group='purkondro.group_send_reminder', default=True,
